    ...
    <div class="flex flex-row-reverse flex-wrap items-center w-3/4 h-full justify-between gap-5
        ...
        <div class="relative aspect-square h-[30rem] flex items-center justify-center
            ...
            <p class="absolute font-black right-16 bottom-5 bg-gradient-to-r px-5 py-2
                ...
                xs:right-14">
                Mharc Nyvhie Guillermo
            </p>
        </div>
        <div class="flex flex-col text-right w-1/2 z-50 bg-gradient-to-l h-60
            from-[#39393f] to-[#1c1c1c] rounded-r-full py-5 px-16 relative
                justify-center drop-shadow-xl
                xs:scale-75 xs:w-full xs:-mt-28 xs:h-56 xs:text-center
                xs:items-center">
            <p class="italic text-3xl absolute right-16 top-8 opacity-70
                xs:text-lg xs:static xs:w-full">
                Let me voice out what my
            </p>
            <h1 class="font-[Bold] text-9xl
                xs:text-8xl">
                brain
            </h1>
            <p class="italic text-3xl absolute left-[7.5rem] bottom-6 opacity-70
                xs:text-lg xs:static xs:w-full xs:-mt-6">
                want to say...
            </p>
